...
if __name__ == "__main__":
    ...
    run = 1
    args.exp = args.encoder + '_FEWTD_kernel_sizes_' + str(
    ...
    snapshot_path = "model_pth/{}/{}".format(args.exp, args.encoder + '_FEWTD_kernel_sizes_' + str(
        args.kernel_sizes) + '_dw_' + dw_mode + '_' + aggregation + '_lgag_ks_' + str(args.lgag_ks) + '_ef' + str(
        args.expansion_factor) + '_act_mscb_' + args.activation_mscb + '_loss_' + args.supervision + '_output_final_layer_Run' + str(
        run))
    ...
    model = FEWTDNet(num_classes=args.num_classes, kernel_sizes=args.kernel_sizes,
